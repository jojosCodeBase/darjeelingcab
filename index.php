...
<head>
    ...
    <title>Darjeeling Cab</title>
    <link rel="icon" href="img/darjeelingcab-logo.png" type="image/x-icon">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand text-light p-0" href="#">
                <img src="img/darjeelingcab-logo.png" class="scr-fit"
                    style="width: 100px; object-fit: cover; padding: 5px;" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                ...
                <div class="btn btn-warning mx-lg-5 mx-sm-3"><a href="tel:+917478459652">Book Now</a></div>
            </div>
        </div>
    </nav>
    ...
    <main>
        <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./img/Kangchenjunga.jpg" alt="Kangchenjunga" class="w-100 h-100 object-fit-cover" />
                    <div class="container">
                        <div class="carousel-caption text-center test-card">
                            <h1 class="carousel-title text-light">Journey into Serenity</h1>
                            ...
                            <div class="buttons">
                                <button class="btn btn-whatsapp cBtn"><i class="fa-solid fa-phone"></i><a href="tel:+917478459652"> Call Now</a></button>
                                <button class="btn btn-warning cBtn" onclick="book()"><i class="fa fa-paper-plane" aria-hidden="true"></i> Book Now</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./img/sandakphu.jpg" alt="sandakphu" class="w-100 h-100 object-fit-cover" />
                    <div class="container">
                ...
                <div class="carousel-item">
                    <img src="./img/darjeeling.jpg" alt="" class="w-100 h-100 object-fit-cover" />
                    <div class="container">
                ...
                <div class="carousel-item">
                    <img src="./img/sikkim.jpg" alt="" class="w-100 h-100 object-fit-cover" />
                    <div class="container">
                        <div class="carousel-caption text-start">
                            <h1 class="carousel-title text-light">Scenic Routes, Seamless Rides.</h1>
        ...
        <div class="container" id="about">
            <div class="row mb-5">
                <div class="col-md-6 col-lg-6 ms-md-3 mb-3">
                    <span class="text-danger mb-5 brand">ABOUT</span>
                    ...
                    <button class="btn btn-danger"><a href="about-us.html"></a>Read more</button>
                </div>
        ...
        <div id="product" class="container-fluid bg-dark">
            <div class="container">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-center p-3 gap-4">

                    <div class="card shadow-sm service-card bg-warning">
                        <img src="./img/bagdogra.jpg" alt="Sightseeing" class="card-img-top">
                        <div class="card-body">
                    ...
                    <div class="card shadow-sm service-card bg-warning">
                        <img src="./img/local-taxi.jpg" alt="Shared Taxi" class="card-img-top">
                        <div class="card-body">
                            <span class="card-text fs-5">
                                Shared Taxi
                            </span>
                    ...
                    <div class="card shadow-sm service-card bg-warning mb-lg-5 mb-md-5">
                        <img src="./img/pickup.jpeg" alt="Pickup/Drop" class="card-img-top rounded-top-2">
                        <div class="card-body">
                            <span class="card-text fs-5">
                                Pickup/Drop
                            </span>
                    ...
                    <div class="card shadow-sm service-card bg-warning">
                        <img src="./img/third-img.jpg" alt="Sightseeing" class="card-img-top">
                        <div class="card-body">
                            <span class="card-text fs-5">
                                Sightseeing
                            </span>
                    ...
                    <div class="card shadow-sm service-card bg-warning mb-5 mb-lg-0 mb-md-0">
                        <img src="./img/train.jpg" alt="Sightseeing" class="card-img-top">
                        <div class="card-body">
                            <span class="card-text fs-5">
                                NJP
                            </span>
        ...
        <!-- product start -->
        <div id="product" class="product container-fluid bg-dark mt-5">
            <div class="row">
                <div class="col">
                    <div class="title">
                        <h2>OUR<strong class="black"> vehicles</strong></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="product_box ">
                                <figure><img src="img/tata-sumo.jpg" class="fit-screen" alt="#" />
                                    <h3>TATA SUMO</h3>
                                </figure>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="product_box">
                                <figure><img src="img/innvoa.jpg" alt="#" class="fit-screen car-fit" />
                                    <h3>TOYOTA INNOVA</h3>
                                </figure>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <div class="product_box">
                                <figure><img src="img/wagonr.jpg" class="car-fit fit-screen" alt="#" />
                                    <h3>WAGON R</h3>
                                </figure>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <div class="product_box">
                                <figure><img src="img/swift-dzire.jpg" class="car-fit fit-screen" alt="#" />
                                    <h3>SWIFT DESIRE </h3>
                                </figure>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="product_box">
                                <figure><img src="img/bolero.jpg" class="fir-screen car-fit" alt="#" />
                                    <h3>BOLERO </h3>
                                </figure>
                            </div>
                        </div>
            ...
            <div class="col-md-3 ms-md-4 mb-3" id="contact">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2"><span class="p-0 text-primary"><i class="fa-solid fa-envelope"></i>
                            <a href="mailto:info@darjeelingcab.in" class="text-primary">info@darjeelingcab.in</a></span>
                    </li>
                    <li class="nav-item">
                        <div class="row mt-4">
